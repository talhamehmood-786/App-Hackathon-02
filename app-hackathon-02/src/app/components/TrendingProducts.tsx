...
function TrendingProducts() {
  const products = [
    { id: 1, img: "/images/chair5.jpg" },
    { id: 2, img: "/images/chair6.jpg" },
    { id: 3, img: "/images/chair7.jpg" },
    { id: 4, img: "/images/product5.jpg" },
  ];

  const exclusiveProducts = [
    { id: 1, img: "/images/chair8.jpg" },
    { id: 2, img: "/images/chair9.jpg" },
    { id: 3, img: "/images/chair10.jpg" },
  ];
          ...
          {exclusiveProducts.map((product) => (
            ...
            >
              ...
              <div>
                ...
                <p className="text-[#3F509E] font-bold inline-block">$29.99</p>
              </div>
            </div>
          ))}
        </div>
