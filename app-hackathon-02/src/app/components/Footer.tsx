    ...
    <div className="bg-gray-100 py-16 text-gray-600">
      <div className="w-[90%] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-2">
           ...
           <Link href={"/Discount"}><li>Discount</li></Link> 
            <li>Returns</li>
            <li>Order History</li>
      ...
      <div className="mt-12 border-t border-gray-200 pt-8">
        <div className="flex justify-between items-center w-[90%] mx-auto">
          <p className="text-gray-500">&copy; Techtrend - All Rights Reserved. Talha Mehmood Khan</p>
          <div className="flex space-x-4">
            <a href="https://www.facebook.com/profile.php?id=100010944310617" className="w-8 h-8 rounded-full bg-[#151875] flex items-center justify-center text-white hover:bg-blue-700">
              <FaFacebookF />
            </a>
            <a href="##" className="w-8 h-8 rounded-full bg-[#151875] flex items-center justify-center text-white hover:bg-blue-700">
              <FaTwitter />
            </a>
            <a href="https://www.instagram.com/mtalha72/" className="w-8 h-8 rounded-full bg-[#151875] flex items-center justify-center text-white hover:bg-blue-700">
              <FaInstagram />
            </a>
          </div>
        </div>
