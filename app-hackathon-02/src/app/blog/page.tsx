        ...
        <div className="lg:w-1/4 lg:pl-10 mt-10 lg:mt-0">
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-2">
              {[
                { id: 4, image: "/images/blog4m.jpg", title: "Recent Blog 1", date: "December 6, 2024" },
                { id: 5, image: "/images/blog5m.jpg", title: "Recent Blog 2", date: "December 5, 2024" },
                { id: 6, image: "/images/blog6m.jpg", title: "Recent Blog 3", date: "December 4, 2024" },
              ].map((blog) => (
